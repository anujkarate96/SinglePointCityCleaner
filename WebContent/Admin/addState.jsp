								...
								<div class="p-20 m-b-20">
									<form action="#" class="form-validation">
										<div class="form-group">
											<label for="sname">State Name<span
												class="text-danger">*</span></label> <input type="text" name="nick"
												parsley-trigger="change" required
												placeholder="Enter State name" class="form-control" id="sn">
										</div>
										<div class="form-group">
											<label for="sdesc">State Description<span
												class="text-danger">*</span></label> <input type="text" name="nick"
												parsley-trigger="change" required
												placeholder="Enter State Description" class="form-control"
												id="sd">
										</div>
										<br>
