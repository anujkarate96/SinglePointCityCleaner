							...
							<div class="p-20 m-b-20">
								...
								<div class="p-20 m-b-20">
									<c:forEach items="${sessionScope.list}" var="j">
										<form
											action="<%=request.getContextPath() %>/AreaController?flag=update"
											...
											<div class="form-group">
												...
												<select name="s">
													<c:forEach items="${sessionScope.list1 }" var="i">
														<c:if test="${i.cid eq j.cityVO.cid}">
															<option value="${i.cid}" selected="selected">${i.cityName}
															</option>
														</c:if>
														<c:if test="${i.cid ne j.cityVO.cid }">
											...
											<div class="form-group">
												...
												<input type="text" name="areaname" parsley-trigger="change"
													required placeholder="Enter Area" class="form-control"
													id="an" value="${j.areaName}">
											</div>
											<div class="form-group">
												<label for="sdesc">Area Description<span
													class="text-danger">*</span></label> <input type="text"
													name="areadescription" parsley-trigger="change" required
													placeholder="Enter Area Description" class="form-control"
													id="ad" value="${j.areaDiscription}">
