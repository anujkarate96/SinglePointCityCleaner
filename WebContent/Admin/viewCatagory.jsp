									...
									<tbody>
										<c:forEach items="${sessionScope.list }" var="i">
											<tr>
												...
												<td>${i.catagoryDiscription }</td>
												<td><a
													href="<%=request.getContextPath()%>/CatagoryController?flag=edit&id=${i.caid}">Edit</a></td>
												<td><a
													href="<%=request.getContextPath()%>/CatagoryController?flag=delete&id=${i.caid}">Delete</a></td>
										</c:forEach>
									</tbody>
								</table>
							</div>
