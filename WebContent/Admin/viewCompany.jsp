									...
									<tbody>
										<c:forEach items="${sessionScope.list }" var="i">
											<tr>
												...
												<td>${i.companyname}</td>
												<td>${i.companydiscription }</td>
												<td>${i.cityVO.cityName}</td>
												<td><a
													href="<%=request.getContextPath()%>/AreaController?flag=edit&id=${i.id}">Edit</a></td>
												<td><a
													href="<%=request.getContextPath()%>/CompanyController?flag=delete&id=${i.id}">Delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
