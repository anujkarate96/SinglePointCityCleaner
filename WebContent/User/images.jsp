									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												63</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												12</a>
										</div>
										<div class="user-info">
											...
											<div class="user">
												<h6>
													<a href="#" class="profile-link">Richard Bell</a>
												</h6>
							...
							<div class="grid-item col-md-6 col-sm-6">
								<div class="media-grid">
									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												100</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												99</a>
										</div>
										<div class="user-info">
											...
											<div class="user">
												<h6>
													<a href="#" class="profile-link">Sarah Cruiz</a>
												</h6>
												<a class="text-green" href="#">Friend</a>
											</div>
										</div>
								...
								<div class="media-grid">
									...
									<div class="media-info">
										...
										<div class="user-info">
											...
											<div class="user">
												<h6>
													<a href="#" class="profile-link">Robert Cook</a>
												</h6>
												<a class="text-green" href="#">Friend</a>
											</div>
										</div>
							...
							<div class="grid-item col-md-6 col-sm-6">
								<div class="media-grid">
									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												73</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												4</a>
										</div>
										<div class="user-info">
											<img src="images/user-4.jpg" alt=""
							...
							<div class="grid-item col-md-6 col-sm-6">
								<div class="media-grid">
									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												55</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												2</a>
										</div>
										<div class="user-info">
											<img src="images/user-5.jpg" alt=""
							...
							<div class="grid-item col-md-6 col-sm-6">
								<div class="media-grid">
									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												81</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												1</a>
										</div>
										<div class="user-info">
									...
									<!--Popup-->
									<div class="modal fade modal-8" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="post-content">
							...
							<div class="grid-item col-md-6 col-sm-6">
								<div class="media-grid">
									...
									<div class="media-info">
										<div class="reaction">
											<a class="btn text-green"><i class="fa fa-thumbs-up"></i>
												47</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
												9</a>
										</div>
										<div class="user-info">
											<img src="images/user-5.jpg" alt=""
									...
									<!--Popup-->
									<div class="modal fade modal-9" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="post-content">
