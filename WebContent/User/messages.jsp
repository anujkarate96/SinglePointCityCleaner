							...
							<div class="col-md-7">
								...
								<div
									...
									<div class="tab-pane active" id="contact-1">
										<div class="chat-body">
											<ul class="chat-message">
												<li class="left"><img src="images/user-2.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
												...
												<li class="right"><img src="images/user-1.jpg" alt=""
									...
									<div class="tab-pane" id="contact-2">
										<div class="chat-body">
											<ul class="chat-message">
												<li class="left"><img src="images/user-10.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
														<div class="chat-item-header">
															<h5>Julia Cox</h5>
									...
									<div class="tab-pane" id="contact-3">
										<div class="chat-body">
											<ul class="chat-message">
												...
												<li class="left"><img src="images/user-3.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
														<div class="chat-item-header">
															<h5>Sophia Lee</h5>
									...
									<div class="tab-pane" id="contact-4">
										<div class="chat-body">
											<ul class="chat-message">
												<li class="left"><img src="images/user-4.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
														<div class="chat-item-header">
															<h5>John Doe</h5>
									...
									<div class="tab-pane" id="contact-5">
										<div class="chat-body">
											<ul class="chat-message">
												<li class="left"><img src="images/user-9.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
														<div class="chat-item-header">
															<h5>Anna Young</h5>
									...
									<div class="tab-pane" id="contact-6">
										<div class="chat-body">
											<ul class="chat-message">
												<li class="left"><img src="images/user-8.jpg" alt=""
													class="profile-photo-sm pull-left" />
													<div class="chat-item">
														<div class="chat-item-header">
															<h5>Richard Bell</h5>
