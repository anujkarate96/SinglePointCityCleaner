	...
	<div id="page-contents">
		<div class="container">
          ...
          ================================================= -->
							...
							<div class="post-detail">
								...
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										13</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										0</a>
								</div>
								...
								<div class="post-text">
									<p>
										...
										mollit anim id est laborum. <i class="em em-anguished"></i> <i
											class="em em-anguished"></i> <i class="em em-anguished"></i>
									</p>
								</div>
								<div class="line-divider"></div>
								<div class="post-comment">
									<img src="images/user-11.jpg" alt="" class="profile-photo-sm" />
									<p>
								...
								<div class="post-comment">
									<img src="images/user-4.jpg" alt="" class="profile-photo-sm" />
									<p>
								...
								<div class="post-comment">
									<img src="images/user-1.jpg" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
					<div class="post-content">
						<video class="post-video" controls> <source
							src="videos/8.mp4" type="video/mp4"></video>
						<div class="post-container">
							...
							<div class="post-detail">
								...
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										75</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										8</a>
								</div>
								<div class="line-divider"></div>
								<div class="post-text">
								...
								<div class="line-divider"></div>
								<div class="post-comment">
									<img src="images/user-14.jpg" alt="" class="profile-photo-sm" />
									<p>
								...
								<div class="post-comment">
									<img src="images/user-1.jpg" alt="" class="profile-photo-sm" />
									<p>
										<a href="timeline.html" class="profile-link">Sarah</a> Lorem
										ipsum dolor sit amet, consectetur adipiscing elit, sed do
										eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
								...
								<div class="post-comment">
									<img src="images/user-2.jpg" alt="" class="profile-photo-sm" />
									<p>
										<a href="timeline.html" class="profile-link">Linda</a> Lorem
										ipsum dolor sit amet, consectetur adipiscing elit, sed do
										eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
					...
					<div class="post-content">
						<div class="post-container">
							...
							<div class="post-detail">
								...
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										23</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										4</a>
								</div>
								<div class="line-divider"></div>
								<div class="post-text">
								...
								<div class="post-comment">
									...
									<p>
										<a href="timeline.html" class="profile-link">Cris </a> Lorem
										ipsum dolor sit amet, consectetur adipiscing elit, sed do
										eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
										enim ad minim veniam <i class="em em-muscle"></i>
									</p>
								</div>
								<div class="post-comment">
									<img src="images/user-1.jpg" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
					<div class="post-content">
						<img src="images/2.jpg" alt="post-image"
							class="img-responsive post-image" />
						<div class="post-container">
							...
							<div class="post-detail">
								...
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										39</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										2</a>
								</div>
								<div class="line-divider"></div>
								<div class="post-text">
								...
								<div class="line-divider"></div>
								<div class="post-comment">
									<img src="images/user-13.jpg" alt="" class="profile-photo-sm" />
									<p>
								...
								<div class="post-comment">
									<img src="images/user-8.jpg" alt="" class="profile-photo-sm" />
									<p>
						...
						<div class="post-container">
							...
							<div class="post-detail">
								<div class="user-info">
									...
									<p class="text-muted">
										<i class="icon ion-ios-location"></i> Went to Niagara Falls
										today
									</p>
								</div>
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										17</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										0</a>
								</div>
								<div class="line-divider"></div>
								<div class="post-text">
								...
								<div class="post-comment">
									...
									<p>
										...
										accusantium doloremque laudantium, totam rem aperiam, eaque
										ipsa quae ab illo inventore veritatis et quasi architecto
										beatae vitae dicta sunt explicabo. <i class="em em-blush"></i>
            ...
            ================================================= -->
					<div class="post-content">
						<img src="images/11.jpg" alt="" class="img-responsive post-image" />
						<div class="post-container">
							...
							<div class="post-detail">
								...
								<div class="reaction">
									<a class="btn text-green"><i class="icon ion-thumbsup"></i>
										2</a> <a class="btn text-red"><i class="fa fa-thumbs-down"></i>
										0</a>
								</div>
								<div class="line-divider"></div>
								<div class="post-text">
								...
								<div class="line-divider"></div>
								<div class="post-comment">
									<img src="images/user-10.jpg" alt="" class="profile-photo-sm" />
									<p>
										<a href="timeline.html" class="profile-link">Julia </a>At vero
