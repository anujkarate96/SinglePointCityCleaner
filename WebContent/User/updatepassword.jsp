					...
					<div class="contact-us">
						<div class="row">
							<div class="col-md-8 col-sm-7">
								<h4 class="grey">Forgot Password</h4>
								<form class="contact-form"
									action="<%=request.getContextPath()%>/ForgotController?flag=update"
									method="post">
									<div class="form-group">
										<input id="form-message" type="text" name="np"
											class="form-control" placeholder="New Password"
											required="required" />
									</div>
									<div class="form-group">
										<input id="form-message" type="text" name="cp"
											class="form-control" placeholder="Confirrm Password"
											required="required" />
									</div>
