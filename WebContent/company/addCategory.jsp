					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="p-20 m-b-20">
								...
								<div class="p-20 m-b-20">
									<form
										action="<%=request.getContextPath() %>/CatagoryController?flag=insert"
										...
										<div class="form-group">
											<label for="cdesc">Category description<span
												class="text-danger">*</span></label> <input type="text"
												name="categorydiscription" parsley-trigger="change" required
												placeholder="Enter Category Description"
												class="form-control" id="sd">
										</div>
										<br>
