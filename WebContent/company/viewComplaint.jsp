										...
										<c:forEach items="${sessionScope.complaintList}" var="i">
											<tr>
												...
												<td><img style="height: 150px; width: 150px"
													src="${pageContext.request.contextPath}/doc/${i.filename}"></td>
												<td>${i.discription}</td>
												<td>${i.date}</td>
												<td>${i.time}</td>
												<td>${i.areaVO.areaName}</td>
												<td>${i.cityVO.cityName}</td>
												<td>${i.complaintfrom.email}</td>
												<td><a
													href="<%=request.getContextPath()%>/NewComplaintController?flag=reply&id=${i.complaintid}">Reply</a></td>
												<td><a
													href="<%=request.getContextPath()%>/NewComplaintController?flag=delete&id=${i.complaintid}">Delete</a></td>
